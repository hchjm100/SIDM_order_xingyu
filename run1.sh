#!/bin/bash -l
#
#SBATCH --output=Gadget2SIDM_%j.out     # Standard output and error log
#
#SBATCH --nodes=1               # Number of nodes
#SBATCH --ntasks=128              # Total MPI tasks (matching mpirun -np 15)
...
#SBATCH --job-name="gadget2_SIDM_AS"
...
mpirun -np 128 ./GadCrater3 run1.param
