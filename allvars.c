...
//int N_DM;		/*!< number of DM particles on the LOCAL processor  */
 ...
 *SIDMDataResult,               /*!< holds the partial results computed for imported particles. Note: We use SIDMDataResult = SIDMDataGet, such that the result replaces the imported data */
 *SIDMDataOut;                  /*!< holds partial results received from other processors. This will overwrite the SIDMDataIn array */

FLOAT Velmin[3], Velmax[3], VelminGlobal[3], VelmaxGlobal[3];
