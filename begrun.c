  ...
  if(ThisTask == 0)		/* read parameter file on process 0 */
    {
      ...
      // 2024.03.12 ZXY: Add a switch of external potential, initial displacement, and restart flag ......
      // ------------------------------------------------------------------------------------------------
      strcpy(tag[nt], "ExternalPotential");
      addr[nt] = &All.ExternalPotential;
      id[nt++] = INT;

      strcpy(tag[nt], "DisplaceOnZXY");
      addr[nt] = &All.DisplaceOnZXY;
      id[nt++] = INT;

      strcpy(tag[nt], "RestartOnZXY");
      addr[nt] = &All.RestartOnZXY;
      id[nt++] = INT;
      //-------------------------------------------------------------------------------------------------
